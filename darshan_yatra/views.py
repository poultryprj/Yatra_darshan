...
API_BASE_URL = "https://lakshyapratishthan.com/LakshyaPratishthan/api/"
...
def Registrationpage1(request):
    ...
    route_yatras_data = []
    # api_url = "https://lakshyapratishthan.com/api/routeyatradates"
...
def registration_api1(request):
    ...
    try:
        ...
        # --- 5. TICKET CHECKS & CARDS ---
            ...
            try:
                api_url = f"{API_BASE_URL}create_upi_qr/"
                payload = {
                    "amount": request.POST.get("amount"),
                    "customer_name": request.POST.get("customer_name", "Passenger"),
                    "customer_mobile": request.POST.get("customer_mobile", "9999999999"),
                    "yatra_name": request.POST.get("yatra_name", "Darshan Yatra")
                }
                response = requests.post(api_url, json=payload, verify=False)
                return JsonResponse(response.json())
            except Exception as e:
            ...
            try:
                ...
                if aadhar_file:
                    ...
                    if ext == ".pdf":
                        ...
                        aadhar_url = f"https://lakshyapratishthan.com/Yatra_darshan/static/assets/adhar/{file_name}.pdf"
                    else:
                        save_path = os.path.join(img_dir, f"{file_name}.png")
                        image = Image.open(aadhar_file).convert("RGB")
                        image.save(save_path, "PNG")
                        aadhar_url = f"https://lakshyapratishthan.com/Yatra_darshan/static/assets/adhar/{file_name}.png"
                ...
                if profile_file:
                    ...
                    if ext == ".pdf":
                        ...
                        profile_url = f"https://lakshyapratishthan.com/Yatra_darshan/static/assets/profile/{file_name}.pdf"
                    else:
                        save_path = os.path.join(img_dir, f"{file_name}.png")
                        image = Image.open(profile_file).convert("RGB")
                        image.save(save_path, "PNG")
                        profile_url = f"https://lakshyapratishthan.com/Yatra_darshan/static/assets/profile/{file_name}.png"
                ...
                if voterId_File:
                    ...
                    if ext == ".pdf":
                        ...
                        voterId_url = f"https://lakshyapratishthan.com/Yatra_darshan/static/assets/voterId/{file_name}.pdf"
                    else:
                        save_path = os.path.join(img_dir, f"{file_name}.png")
                        image = Image.open(voterId_File).convert("RGB")
                        image.save(save_path, "PNG")
                        voterId_url = f"https://lakshyapratishthan.com/Yatra_darshan/static/assets/voterId/{file_name}.png"
...
def user_master(request):
    ...
    # api_url = "https://lakshyapratishthan.com/api/listuserall"
...
def user_master_api(request):
    ...
    if request.method == 'POST':
        ...
        try:
            if action == 'add_user':
                # api_url = "https://lakshyapratishthan.com/api/insertuser"
                ...
                # api_url = "https://lakshyapratishthan.com/api/modifyuser"
                ...
                # api_url = "https://lakshyapratishthan.com/api/deleteuser"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for item in summary_data:
                ...
                if active_yatra_ids and str(yatra_id) not in active_yatra_ids:
                    continue
    ...
    try:
        ...
        if response_data.get('message_code') == 1000 and response_data.get('message_data'):
            ...
            if partial_path.startswith('http'):
                ...
                if not partial_path.startswith('/'):
                    partial_path = '/' + partial_path
                full_image_url = f"{backend_domain}{partial_path}"
            
            response_data['message_data'] = full_image_url
...
def daily_report_api(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # api_url = "https://lakshyapratishthan.com/api/agentbookings"
...
def print_passenger_list(request, route_id):
    ...
    try:
        ...
        # api_url = "https://lakshyapratishthan.com/api/yatrabookings"
...
def send_whatsapp_api(request):
    ...
    if request.method == 'POST':
        try:
            ...
            send_api_url = "https://lakshyapratishthan.com/api/addsmsrequest"
            payload = {
...
def get_whatsapp_templates_api(request):
    ...
    try:
        template_api_url = "https://lakshyapratishthan.com/api/listsmstemplate"
    ...
    try:
        ...
        if action == "submit":
            ...
            if not record_id or str(record_id) == "0":
                check_api = "https://lakshyapratishthan.com/LakshyaPratishthan/api/check_rationcard/"
            ...
            if not TokenNo:
                token_api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/add_diwali_kirana/"
                token_payload = {
...
def rationcardscan(request):
    ...
    if request.method == 'POST':
        try:
            ...
            api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/update_token_status/"
    ...
    if token:
        try:
            ...
            api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/list_family/"
...
def change_diwali_token(request):
    ...
    try:
        ...
        api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/change_diwali_token/"
        payload = {
...
def diwali_report_page(request):
    ...
    try:
        ...
        area_map = {}
        area_api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/listareaall/"
        ...
        registrations_api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/list_diwalikirana/"
...
def delete_diwali_member(request, reg_id):
    ...
    try:
        ...
        api_url = f"https://lakshyapratishthan.com/LakshyaPratishthan/api/delete_diwali_member/{reg_id}/"
...
def darshan_yatra_management(request):
    ...
    try:
        ...
        area_api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/listarea/"
...
def registration_details_page(request, event_id, registration_id):
    ...
    context = {
        'event_id': event_id,
        'registration_id': registration_id,
        'api_base_url': "https://lakshyapratishthan.com/LakshyaPratishthan/api/" # Or your actual API URL
    }
